...
class SalonWorkflowTests(TestCase):
    ...
    def test_dashboard_requires_login(self):
        ...
        self.assertIn('/worker/login/', response.url)
    ...
    def test_worker_sign_in_is_available_and_owner_sign_in_is_removed(self):
        ...
        self.assertEqual(self.client.get('/worker/login/').status_code, 200)
        self.assertEqual(self.client.get('/owner/login/').status_code, 404)
