...
urlpatterns = [
    ...
    path('contact/', views.contact, name='contact'), path('book/', views.book, name='book'), path('book/<int:pk>/pay/', views.booking_pay, name='booking_pay'),
    ...
    path('walk-ins/new/', views.walk_in_create, name='walk_in_create'), path('owner/walk-ins/<int:pk>/', views.walk_in_manage, name='walk_in_manage'), path('walk-ins/<int:pk>/complete/', views.walk_in_complete, name='walk_in_complete'), path('reports.csv', views.report_csv, name='report_csv'),
]
